...
#     # Input type
#     parser.add_argument('--auto_resume', action='store_true', help='resume from the latest checkpoint or not')
...
#     parser.add_argument('--warehouse', default='data/TSP_with_obstacle/kiva-10-500-5.map', help="path to the warehouse")
...
#     parser.add_argument('--task_num', type=int, default=20, help="The size of the problem graph")
#     parser.add_argument('--batch_size', type=int, default=512, help='Number of instances per batch during training')
#     parser.add_argument('--epoch_size', type=int, default=1280000, help='Number of instances per epoch during training')
#     parser.add_argument('--val_size', type=int, default=10000,
#                         help='Number of instances used for reporting validation performance')
#     parser.add_argument('--val_dataset', type=str, default=None, help='Dataset file to use for validation')
#     parser.add_argument('--train_dataset', type=str, default=None, help='Dataset file to use for validation')
...
#         opts.output_dir,
#         "{}_{}".format(opts.problem, opts.task_num),
#         opts.run_name
#     )
